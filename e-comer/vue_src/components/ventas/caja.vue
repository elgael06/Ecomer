    ...
    <div class="panel panel-info">
        ...
        <div style="height:340px;overflow:auto">
            <table class="table table-condensed">
                ...
                <tbody>
                    <productoLista v-for="(item,index) in productos_lista" 
...
export default {
    ...
    methods: {
        agregar_producto(producto){
            ...
            let index = this.productos_lista.findIndex(e=>e.folio == producto.id);
                if(index==-1){
                    ...
                    this.productos_lista[index].total += ((producto.venta *(1-(this.productos_lista[index].descuento/100))) 
                    || producto.venta);
                }
            }
        ...
        eliminar(index){
            if(confirm("Eliminar ?"))
                this.productos_lista.splice(index,1);
        },
        indicadores(){
